...
export const addressSuwon: string = getSiteConfig('addressSuwon')
export const addressCheonan: string = getSiteConfig('addressCheonan')
export const suwonTel: string = getSiteConfig('suwonTel')
export const cheonanTel: string = getSiteConfig('cheonanTel')
...
export const groupware: string | null = getSiteConfig('groupware', null)
